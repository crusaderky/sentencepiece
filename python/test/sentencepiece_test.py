...
class TestSentencepieceProcessor(unittest.TestCase):
    ...
    def test_immutable_proto(self):
        ...
        for i in range(len(s3.nbests)):
            ...
            self.assertEqual(self.sp_.Decode([x.id for x in s3.nbests[i].pieces]), text)
    ...
    def test_normalize(self):
        ...
        self.assertEqual([0, 0, 0, 0, 3, 6, 9, 12, 15, 18, 21, 24, 25, 26, 27], x[1])
        ...
        self.assertEqual([0, 0, 0, 0, 3, 6, 9, 12, 15, 18, 21, 24, 25, 26, 27], x[0][1])
